...
OUTPUT_GENES="intestine_fatty_acid_genes.ffn"
# List of fatty acid biosynthesis genes
GENE_LIST=("epaB" "fabA" "fabB" "fabD" "fabF" "fabG" "fabH" "fabI" "fabM" "fabZ" "accA" "accB" "accC" "accD")
# Extract matching gene IDs from the GFF file based on 'locus_tag=' field
echo "Extracting fatty acid biosynthesis gene IDs..."
...
if [ -s gene_ids.txt ]; then
    ...
    echo "Extraction complete. Fatty acid biosynthesis genes saved to $OUTPUT_GENES"
else
...
OUTPUT_GENES="burongisda_fatty_acid_genes.ffn"
# List of fatty acid biosynthesis genes
GENE_LIST=("epaB" "fabA" "fabB" "fabD" "fabF" "fabG" "fabH" "fabI" "fabM" "fabZ" "accA" "accB" "accC" "accD")
# Extract matching gene IDs from the GFF file based on 'locus_tag=' field
echo "Extracting fatty acid biosynthesis gene IDs..."
...
OUTPUT_GENES="strainA_fatty_acid_genes.ffn"
# List of fatty acid biosynthesis genes
GENE_LIST=("epaB" "fabA" "fabB" "fabD" "fabF" "fabG" "fabH" "fabI" "fabM" "fabZ" "accA" "accB" "accC" "accD")
# Extract matching gene IDs from the GFF file based on 'locus_tag=' field
echo "Extracting fatty acid biosynthesis gene IDs..."
...
OUTPUT_GENES="strainB_fatty_acid_genes.ffn"
# List of fatty acid biosynthesis genes
GENE_LIST=("epaB" "fabA" "fabB" "fabD" "fabF" "fabG" "fabH" "fabI" "fabM" "fabZ" "accA" "accB" "accC" "accD")
# Extract matching gene IDs from the GFF file based on 'locus_tag=' field
echo "Extracting fatty acid biosynthesis gene IDs..."
...
OUTPUT_GENES="strainC_fatty_acid_genes.ffn"
# List of fatty acid biosynthesis genes
GENE_LIST=("epaB" "fabA" "fabB" "fabD" "fabF" "fabG" "fabH" "fabI" "fabM" "fabZ" "accA" "accB" "accC" "accD")
# Extract matching gene IDs from the GFF file based on 'locus_tag=' field
echo "Extracting fatty acid biosynthesis gene IDs..."
